...
public class BaseThemeSettings extends ThemeListener {
    ...
    @ThemeColor(IWorkbenchThemeConstants.INACTIVE_TAB_BG_START)
    public volatile Color colorWidgetBackground;
    @ThemeColor(IWorkbenchThemeConstants.ACTIVE_TAB_TEXT_COLOR)
    public volatile Color colorWidgetForeground;
